...
path = r'E:\Blog\source\_posts\DBSTANet\DBSTANet\DBSTANet\1rirnoisy_fileid_411.wav'
save_path = r'E:\Blog\source\_posts\DBSTANet\DBSTANet\DBSTANet\1rirnoisy_fileid_411.png'
f = wave.open(path, "rb")
params = f.getparams()
