...
path = r'C:\Users\Administrator\Desktop\DBSTANet\DBSTANet\1rirnoisy_fileid_2.wav'
save_path = r'C:\Users\Administrator\Desktop\DBSTANet\DBSTANet\1rirnoisy_fileid_2.png'
f = wave.open(path, "rb")
params = f.getparams()
