...
path = r'E:\Blog\source\_posts\SAMSTCN\SAMSTCN\SAMSTCN\rir_noisy_fileid_98.wav'
save_path = r'E:\Blog\source\_posts\SAMSTCN\SAMSTCN\SAMSTCN\rir_noisy_fileid_98.png'
f = wave.open(path, "rb")
params = f.getparams()
