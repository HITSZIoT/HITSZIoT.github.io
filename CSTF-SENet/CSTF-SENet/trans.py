...
old_path = r'E:\Blog\source\_posts\CSTF-SENet\CSTF-SENet\noisy\p232_096.wav'
save_path = r'E:\Blog\source\_posts\CSTF-SENet\CSTF-SENet\noisy\p232_096.png'

data, samplerate = soundfile.read(old_path)

soundfile.write('new.wav', data, samplerate, subtype='PCM_16')
path = r"E:\Blog\source\_posts\CSTF-SENet\CSTF-SENet\new.wav"
