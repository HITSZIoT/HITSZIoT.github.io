...
path = r'E:\Blog\source\_posts\DBDIUNet\DBDIUNet\clean\1clean_fileid_142.wav'
save_path = r'E:\Blog\source\_posts\DBDIUNet\DBDIUNet\clean\1clean_fileid_142.png'
f = wave.open(path, "rb")
params = f.getparams()
