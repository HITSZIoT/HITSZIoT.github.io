...
wav_files = glob.glob(r'E:\Blog\source\_posts\PriorSinger\PriorSinger\HifiGAN\*')

path = r"E:\Blog\source\_posts\PriorSinger\PriorSinger\new.wav"

for wav_item in wav_files:
    save_path = wav_item.replace('.wav', '.png')

    data, samplerate = soundfile.read(wav_item)
